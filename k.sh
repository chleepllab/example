...
cd ~/example
make clea
~/iree-build/runtime/src/iree/builtins/ukernel/tools/conv_2d_nchw_fchw_test
#scp ~/iree-build-riscv/tools/iree-run-module chlee@140.114.78.64:~
scp ~/iree-build-riscv/runtime/src/iree/builtins/ukernel/tools/conv_2d_nchw_fchw_test chlee@140.114.78.64:~
