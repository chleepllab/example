#config = #iree_cpu.lowering_config<distribution = [8, 64], vector_common_parallel = [1, 1]>
...
module attributes {stream.affinity.default = #hal.device.affinity<@__device_0>} {
  ...
  hal.executable private @matmul_dynamic_dispatch_0 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @matmul_dynamic_dispatch_0_pack_f32() attributes {translation_info = #translation} {
          ...
          %pack = linalg.pack %27 inner_dims_pos = [0, 1] inner_tiles = [8, 1] into %28 {lowering_config = #config} : tensor<?x?xf32> -> tensor<?x?x8x1xf32>
